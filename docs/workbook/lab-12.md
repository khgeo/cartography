...
ប្រើ duplicated layers សម្រាប់ឆ្នាំផ្សេង ហើយ copy/paste style ដើម្បីរក្សាព្រំថ្នាក់។ ក្នុង Layout ដាក់ map frames ពីរដែលមាន extent ដូចគ្នា។ សម្រាប់ទិន្នន័យមានកាលបរិច្ឆេទ អាចប្រើ Temporal Controller។

បើគ្មាន Cambodia.zip ពេញលេញ ប្រើទិន្នន័យសាកល្បងក្នុង [កញ្ចប់អនុវត្ត offline](../appendix/d-offline-practice.md)។ តម្លៃសំយោគមានចម្លើយផ្សេងពីទិន្នន័យដើម៖ កុំប្រើវាដើម្បីឆ្លើយប្រអប់លេខថេរខាងលើ។ ត្រឡប់ទៅ [មេរៀន 12](../lessons/lesson-12.md) ដើម្បីធ្វើពិសោធន៍ និងសំណួរថ្មី។
