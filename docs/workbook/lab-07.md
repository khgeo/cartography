...
Layer Properties → Symbology → Graduated។ ប្រើវាលដង់ស៊ីតេដដែល និងពណ៌ដដែល សម្រាប់ Equal Interval, Equal Count និង Natural Breaks។ រក្សាទុក Style បី ហើយកត់ព្រំថ្នាក់មុនប្តូរ។

បើគ្មាន Cambodia.zip ពេញលេញ ប្រើទិន្នន័យសាកល្បងក្នុង [កញ្ចប់អនុវត្ត offline](../appendix/d-offline-practice.md)។ តម្លៃសំយោគមានចម្លើយផ្សេងពីទិន្នន័យដើម៖ កុំប្រើវាដើម្បីឆ្លើយប្រអប់លេខថេរខាងលើ។ ត្រឡប់ទៅ [មេរៀន 7](../lessons/lesson-07.md) ដើម្បីធ្វើពិសោធន៍ និងសំណួរថ្មី។
