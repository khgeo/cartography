...
(function () {
  ...
  const LAB_MAPS = {
    ...
    "lab-11-swipe": {
      ...
      layers: [
        { id: "lc97", file: "lc1997.geojson", name: "គម្របដី ១៩៩៧", on: true, style: lcStyle,
          popup: (p) => `<b>${p.kh}</b> · ១៩៩៧` },
        { id: "lc15", file: "lc2015.geojson", name: "គម្របដី ២០១៥", on: true, style: lcStyle,
  ...
  const CHARTS = {
    ...
    "l08-kkg-years": { title: "គម្របដីក្នុងស្រទាប់ KKG_LC ទាំងបីឆ្នាំ (ហិកតា · មុន Clip)", scale: "sqrt",
    ...
    "lab-11-classes": {
      title: "ផ្ទៃគម្របដីខេត្តកោះកុង (ហិកតា)",
  ...
  const QUIZZES = {
    ...
    "lab-11-tools": {
      ...
      pairs: [
        ...
        ["Clip", "កាត់គម្របដីឲ្យនៅត្រឹមព្រំខេត្ត"],
